...
const char * const BITCOIN_CONF_FILENAME = "MCAN.conf";
const char * const BITCOIN_PID_FILENAME = "MCAN.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MCAN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MCAN";
#else
    // Unix
    return pathRet / ".MCAN";
#endif
