...
#if defined(NDEBUG)
# error "MCAN cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MCAN Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MCAN additional fees, %d delta bytes\n",
