...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s MCAN-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  MCAN-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MCAN transaction") + "\n" +
              "  MCAN-tx [options] -create [commands]   " + _("Create hex-encoded MCAN transaction") + "\n" +
              "\n";
