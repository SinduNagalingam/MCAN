...
{
    const char* pszTimestamp = "BBC NEWS 15/Jun/2018 Molten java meets the sea";
...
public:
    CMainParams() {
      ...
      /*   consensus.powForkTime = POW_FORK_TIME;              // Time of PoW hash method change
        ...
        // vSeeds.emplace_back("seed-a.MCAN.loshan.co.uk", true);
         vSeeds.emplace_back("206.81.9.7:62458", true);
        vSeeds.emplace_back("206.81.14.114:62458", true);
      //  vSeeds.emplace_back("dnsseed.MCANtools.com", false);
        //vSeeds.emplace_back("dnsseed.MCANpool.org", false);
